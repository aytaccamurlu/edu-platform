...
export default function UserDashboard() {
  ...
  useEffect(() => {
    axios.get("https://edu-platform-backend-9j95.onrender.com/courses").then(res => setCourses(res.data));
  }, []);

  async function buyCourse(course) {
    await axios.post("https://edu-platform-backend-9j95.onrender.com/purchases", {
      userId: user.id,
      courseId: course.id,
      status: "paid"
    });
