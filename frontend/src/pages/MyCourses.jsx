...
export default function MyCourses() {
  ...
  useEffect(() => {
    async function load() {
      ...
      const purchasesRes = await axios.get(`https://edu-platform-backend-9j95.onrender.com/purchases?userId=${user.id}`);
      const purchases = purchasesRes.data;

      const coursesRes = await axios.get("https://edu-platform-backend-9j95.onrender.com/courses");
